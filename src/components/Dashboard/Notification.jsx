...
const Notification = ({ ticket: ticketData, user: userData }) => {
  const [ticket, setTicket] = useState([]);

  const [ticketLabel, setTicketLabel] = useState("manager");
  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-10 mt-10 ">
        ...
        <div className="mb-10">
          <div className="border border-teal-500 rounded-md">
            <div className="flex px-5  items-center justify-between font-bold border-teal-500 border-b-2 rounded-b-md bg-[#6dfdde5d] ">
            ...
            {ticketLabel === "manager"
              ? ticket?.manager?.map((item, index) => (
                  <div className="flex gap-5 p-5 justify-between" key={index}>
        ...
        <div className="mr-8">
          <div className="border border-teal-500 rounded-md">
            ...
            <div className="w-full p-5 py-1">
              {userType === "manager"
                ? user?.manager?.map((item, index) => (
                    <div className="flex  gap-5 my-7" key={index}>
                      <Avatar
                        alt="cindy"
